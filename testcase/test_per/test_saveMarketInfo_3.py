...
from api_util.per_util.per_api import saveMarketInfo, getMarketInfo


class Test_saveMarketInfo:
    @pytest.mark.run(order=1)
    @pytest.mark.parametrize('userinfo', america_parma_per["saveMarketInfo"])
    ...
    @pytest.mark.parametrize('userinfo', america_parma_per["saveMarketInfo_two"])
