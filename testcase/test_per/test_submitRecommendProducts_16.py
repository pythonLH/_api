...
from api_util.per_util.per_api import submitOneProduct, loan_queryAvailableProduct
...
class Test_submitOneProduct:
    def setup_class(self):
        ...
        :return:
        """
        _parma = america_parma_per['queryAvailableProduct'][1]
    ...
    @pytest.mark.parametrize('_submitOneProduct', america_parma_per['submitOneProduct'])
    def test_submitOneProduct(self, _submitOneProduct):

        for item in america_parma_per['submitOneProduct']:
